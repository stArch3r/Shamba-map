...
$this->title = 'SHAMBANI';
 ...
 <div class="row">
   ...
   <div class="col-md-6">
     <div class="row">
       ...
       <div class="col-md-3">
      <a href="your link here"> <i class="fa fa-share fa-2x"></i></a>
       </div>
     </div>
      ...
      <div class="col">
        <div class="col">
        <h4>  <hr> <p> Kings with Vineyards </p> </h4>
      </div>
      <div class="col">
        <b> <h1> usd 60000 </h1> </b>
      </div>
          <button type="button" class="btn btn-primary caller" > contact seller </button>
          <button type="button" class="btn btn-primary book" > book tours</button>
         </div>
        </div>
        </div>
      <div class="col-md-6">
  ...
  <div id="facts" class="tabcontent">
    <h3>facts</h3>
    <p> Ruiru is located on exit 14 along thika road</p>
  </div>

  <div id="features" class="tabcontent">
    <h3>features</h3>
    <p> the area comes with a fully done tarmac and serwer  system </p>
  </div>

  <div id="other" class="tabcontent">
    <h3>other </h3>
    <p> literally any other thing could be placed here , no seriously am not kidding </p>
  </div>
 ...
 Get a free qoute and site tour now !
  </textarea>
  <br><br>
...
<?php
        ...
        echo "<div id='callerContent'></div>";
        Modal::end();
      ?>
      <?php
              Modal::begin([
                  'header'=>'<h4>book tour </h4>',
                  'id'=>'book',
                  'size'=>'modal-lg',
                  ]);
